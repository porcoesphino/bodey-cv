...
{
\begin{itemize}
\item Implemented the ground control manager for controlling and configuring UAVs using JavaScript \& PHP to network with the ground control server.
\item Implemented the first version of the ground control manager prototype in Java.
\item Designed and wrote the firmware and boot loaders for our peripheral devices using C and the Code Sourcery toolchain. This required knowledge of UDP, CAN and reverse engineering of third party bus protocols.
